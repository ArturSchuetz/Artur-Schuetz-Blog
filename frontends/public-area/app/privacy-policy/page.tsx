...
export async function generateMetadata() {
  ...
  const canonical_site_url = '/privacy-policy';

  return {
    title: page_title + ' | ' + siteConfig.site.title,
    keywords: 'project, projects, portfolio, artur, schütz, privacy, policy',
        ...
        <div className="container">
          <div className="contact white-box">
            <div className="row">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to {siteConfig.author.name}
                    Blog.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to {siteConfig.site.title},
                    accessible from{" "}
                    <a
                      href={getConfig().baseUrl}
              ...
              <ul>
                <li>
                  <p>By email: <a href={`mailto:${siteConfig.author.email}`}>{siteConfig.author.email}</a></p>
                </li>
                <li>
                  <p>By phone number: <a href={`tel:${siteConfig.author.phone}`}>{siteConfig.author.phone}</a></p>
                </li>
              </ul>
            </div>
          </div>
