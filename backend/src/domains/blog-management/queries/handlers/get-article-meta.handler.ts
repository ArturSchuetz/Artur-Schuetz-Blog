...
import { GetBlogArticleMetaQuery } from '../get-article-meta.query';
...
@QueryHandler(GetBlogArticleMetaQuery)
export class GetBlogArticleMetaHandler implements IQueryHandler<GetBlogArticleMetaQuery> {
  private readonly logger = new Logger(GetBlogArticleMetaHandler.name);
  ...
  async execute(query: GetBlogArticleMetaQuery): Promise<GetBlogArticleResponse> {
